...
const reducer = createReducer({
	...
	[actions.imageCountLoading]: state => ({ ...state, status: { isLoading: true, error: false } }),
	[actions.imageCountSuccess]: (state, imageCount) => ({ ...state, status: { isLoading: false, error: false } }),
